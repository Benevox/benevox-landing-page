    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-20 container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-20">
          <h1 className="text-3xl md:text-7xl font-black mb-6 tracking-tighter uppercase">
            Engineering-as-a-Service
          </h1>
          <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed">
            Three precision-engineered engagement models designed to fit your
            project's maturity and risk profile.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-32">
          ...
          <div className="p-8 rounded-2xl border border-border bg-card">
            ...
            <p className="text-brand-green font-semibold mb-4 text-sm uppercase tracking-widest">
              Predictable
            </p>
            <p className="text-muted-foreground mb-6">
              Best for projects with absolute requirements. We own the delivery
              risk by scoping first and building second.
            </p>
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                <Check className="h-4 w-4 text-brand-green" /> Locked Budget
              </li>
              <li className="flex items-center gap-2">
                <Check className="h-4 w-4 text-brand-green" /> Defined
                Milestones
              </li>
              <li className="flex items-center gap-2">
                <Check className="h-4 w-4 text-brand-green" /> Scoping Required
              </li>
            </ul>
          </div>
          ...
          <div className="p-8 rounded-2xl border border-border bg-card">
            ...
            <p className="text-brand-gold font-semibold mb-4 text-sm uppercase tracking-widest">
              Fast
            </p>
            <p className="text-muted-foreground mb-6">
              Our fastest model for rapid iteration. Plug a pod into your
              roadmap and start shipping in weekly sprints.
            </p>
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                <Check className="h-4 w-4 text-brand-gold" /> Weekly Sprints
              </li>
              <li className="flex items-center gap-2">
                <Check className="h-4 w-4 text-brand-gold" /> Fluid Backlog
              </li>
              <li className="flex items-center gap-2">
                <Check className="h-4 w-4 text-brand-gold" /> Pay-as-you-go
              </li>
            </ul>
          </div>
          ...
          <div className="p-8 rounded-2xl border border-border bg-card">
            ...
            <p className="text-brand-red font-semibold mb-4 text-sm uppercase tracking-widest">
              Strategic
            </p>
            <p className="text-muted-foreground mb-6">
              The 80/20 split. Strategic roadmap planning with tactical sprint
              execution for scaling products.
            </p>
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                <Check className="h-4 w-4 text-brand-red" /> Roadmap Ownership
              </li>
              <li className="flex items-center gap-2">
                <Check className="h-4 w-4 text-brand-red" /> Tactical Sprints
              </li>
              <li className="flex items-center gap-2">
                <Check className="h-4 w-4 text-brand-red" /> Quarterly Reviews
              </li>
            </ul>
          </div>
        </div>
